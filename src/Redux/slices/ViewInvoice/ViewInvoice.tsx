        ...
        <div className="invoice-box bg-white  mt-5 shadow-md rounded-xl ">
          <div className="invoice-details-content md:py-10">
            ...
            <section className="price-overview bg-[#F8F8FB] w-full min-h-[300px] mt-5 rounded-xl">
              <div className="headline hidden md:grid md:grid-cols-4 px-5">
              ...
              <ul className="content-item-list px-6 py-6 grid grid-cols-2 w-full gap-5 md:grid-cols-4">
                <Item />
                <Item />
                <Item />
              </ul>
...
function TitleAndAdress() {
  return (
    <section className="invoice-title-and-adress grid grid-cols-1 md:grid-cols-2 w-full gap-5 px-2">
...
function InvoiceInfos() {
  return (
    <section className="grid grid-cols-2 mt-4 gap-2 md:grid-cols-3 px-2">
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2 ">
        <h1 className="font-bold">Banner Design</h1>
...
function TotalBox() {
  return (
    <section className="total-box min-h-[80px] bg-[#1E2139] rounded-b-xl">
